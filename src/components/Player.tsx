  ...
  return (
    <div className="player" ref={wrapRef}>
      <div className="player-frame">
        ...
        {hasVideo && !ready && <div className="player-empty">Cargando reproductor…</div>}
      ...
      <div className="controls">
        ...
        />
        <span className="time dim">{fmtTime(dur)}</span>
      ...
      {state?.videoTitle && (
        <div className="now-playing" title={state.videoTitle}>
          {state.videoTitle}
        </div>
      )}
    </div>
